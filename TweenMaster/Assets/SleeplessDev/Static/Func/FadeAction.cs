...
{
	public class FadeAction : ITweenAction
	{
		private readonly float _endValue;
		private readonly float _tweenTime;
		private readonly Ease _ease;

		public FadeAction(float endValue, float tweenTime = 1f, Ease ease = Ease.InOutExpo)
		{
			_endValue = endValue;
		...
		public Tweener Apply(Transform t, UnityAction completeAction = null)
		{
			...
			return image.DOFade(_endValue, _tweenTime)
				.SetEase(_ease)
